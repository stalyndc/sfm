...
$__pub = dirname(__DIR__);                 // .../public_html
$__sec = dirname($__pub) . '/secure';      // .../secure

if (is_file($__sec . '/config.php')) {
    // May define SFM_LOG_ENABLED and SFM_LOG_DIR
    @require_once $__sec . '/config.php';
}

// Defaults if not provided by secure/config.php
if (!defined('SFM_LOG_ENABLED')) define('SFM_LOG_ENABLED', true);
if (!defined('SFM_LOG_DIR'))     define('SFM_LOG_DIR', $__sec . '/logs');
